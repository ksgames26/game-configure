import { MessageType, RepeatType, ScalarType } from "db://game-protobuf/game-framework";
...
export class SyntaxTreeNode extends MessageType<Expressions> {
    ...
    public constructor(
        ...
        public mod: string,
        public left: IGameFramework.Nullable<SyntaxTreeNode>,
        public right: IGameFramework.Nullable<SyntaxTreeNode>,
        public valNumber: number,
        public valString: string = "",
        public args: SyntaxTreeNode[],
    ) {
        super("SyntaxTreeNode", [
